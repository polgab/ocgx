...
\long\def\switchOCG#1#2{%
  \def\ocgx@toswitch{}%
  \ocgx@switchOCG#1 ENDOFOCGS %
  \hbox{%
    \pdfannot{%
      /Subtype /Link
      /A << /S/SetOCGState /State [/Toggle \ocgx@toswitch] >>
      /Border [0 0 0]
    }%
    #2}%
  }
...
\long\def\showOCG#1#2{%
  \def\ocgx@toshow{}%
  \ocgx@showOCG#1 ENDOFOCGS %
  \hbox{%
    \pdfannot{%
    /Subtype/Link
    /A << /S/SetOCGState
          /State [/ON \ocgx@toshow] >>
          /Border [0 0 0]
        }%
    #2}%
  }
...
\long\def\hideOCG#1#2{%
  \def\ocgx@tohide{}%
  \ocgx@hideOCG#1 ENDOFOCGS %
  \hbox{%
    \pdfannot{%
    /Subtype/Link
    /A << /S/SetOCGState
          /State [/OFF \ocgx@tohide] >>
          /Border [0 0 0]
        }%
    #2}%
  }
...
\long\def\actionsOCG#1#2#3#4{
  ...
  \def\ocgx@tohide{}%
  \ocgx@switchOCG#1 ENDOFOCGS %
  \ocgx@showOCG#2 ENDOFOCGS %
  \ocgx@hideOCG#3 ENDOFOCGS %
  \hbox{%
    \pdfannot{%
    /Subtype/Link
    /A << /S/SetOCGState
...
\def\ocgx@switchOCG#1 {%
  \unless\ifcsname ocgx@end:#1\endcsname
    \ifcsname ocgx@OCG_#1\endcsname
      \expandafter\def\expandafter\ocgx@toswitch\expandafter{%
        \ocgx@toswitch
        \csname ocgx@OCG_#1\endcsname 0 R }%
    \fi%
    \expandafter\ocgx@switchOCG
  \fi
}
...
\def\ocgx@showOCG#1 {%
  \unless\ifcsname ocgx@end:#1\endcsname
    \ifcsname ocgx@OCG_#1\endcsname
      \expandafter\def\expandafter\ocgx@toshow\expandafter{%
        \ocgx@toshow
        \csname ocgx@OCG_#1\endcsname 0 R }%
    \fi%
    \expandafter\ocgx@showOCG
  \fi
}
...
\def\ocgx@hideOCG#1 {%
  \unless\ifcsname ocgx@end:#1\endcsname
    \ifcsname ocgx@OCG_#1\endcsname
      \expandafter\def\expandafter\ocgx@tohide\expandafter{%
        \ocgx@tohide
        \csname ocgx@OCG_#1\endcsname 0 R }%
    \fi%
    \expandafter\ocgx@hideOCG
  \fi
}
