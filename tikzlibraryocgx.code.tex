...
\tikzset{
  invisiblerule/.style={
    text opacity=0,inner sep=0,outer sep=0,anchor=center,
  },
}
\def\invisiblerule#1#2{\rule{#1}{#2}}
\else
\tikzset{
  invisiblerule/.style={
    inner sep=0,outer sep=0,anchor=center,
  },
}
\def\invisiblerule#1#2{\phantom{\rule{#1}{#2}}}
\fi
  ...
  switch ocg/.style={
    postaction={
      path picture={
        ...
        node[invisiblerule]{\switchocg{#1}{\invisiblerule{\x3}{\y3}}};
      }
    },
  },
  ...
  show ocg/.style={
    postaction={
      path picture={
        ...
        in
        (path picture bounding box.center)
        node[invisiblerule]{\showocg{#1}{\invisiblerule{\x3}{\y3}}};
      },
    },
  },
  hide ocg/.style={
    postaction={
      path picture={
        ...
        in
        (path picture bounding box.center)
        node[invisiblerule]{\hideocg{#1}{\invisiblerule{\x3}{\y3}}};
      },
    },
  },
  actions ocg/.style n args={3}{
    postaction={
      path picture={
        ...
        in
        (path picture bounding box.center)
        node[invisiblerule]{\actionsocg{#1}{#2}{#3}{\invisiblerule{\x3}{\y3}}};
      },
    },
  },
}
