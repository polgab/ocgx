...
\begin{frame}
  ...
  {\centering
    \begin{tikzpicture}
      \OCG{protrusion}{
        ...
        \OCG{expansion-and-protrusion}{%
          \microtypesetup{expansion=true}%
          \node[sampletext]{\sampletext\par};%
        }
        
        \OCG*{no-expansion-and-protrusion}{%
      ...
      \OCG*{no-protrusion}{
        ...
        \OCG{expansion-and-no-protrusion}{%
          \microtypesetup{expansion=true}%
          \node[sampletext]{\sampletext\par};%
        }
        
        \OCG*{no-expansion-and-no-protrusion}{%
          \microtypesetup{expansion=false}%
          \node[sampletext]{\sampletext\par};%
        }
      }
  ...
  \begin{tikzpicture}
    \node[checkbox,
    switch with mark={protrusion}{protrusion no-protrusion}]
    {};
