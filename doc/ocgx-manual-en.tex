...
\setlength{\parskip}{.5\baselineskip plus .5\baselineskip minus .2\baselineskip}
\usepackage{tikz}
...
\begin{filecontents*}{ocgx-example-1}
...
\subsubsection*{How to transform nodes or paths in clickable link}
